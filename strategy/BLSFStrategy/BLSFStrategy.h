...
// create_instance TKSs333 BLSFStrategy UIUC SIM-1001-101 dlariviere 10000000 -symbols SPY
...
public:
    BLSFStrategy(StrategyID strategyID, const std::string& strategyName, const std::string& groupName);
    ~BLSFStrategy();
